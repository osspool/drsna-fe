...
export const navigationData = [
  ...
  },
  {
    ...
    children: [
      {
        id: "life-optimisation",
        label: "Life Optimisation",
        description: "Signature concierge programmes for total-body upgrading",
        href: "/treatments/life-optimization/life-optimisation",
      },
      {
        id: "swallowable-gastric-balloon-weight-transformation",
        label: "Swallowable Gastric Balloon Weight Transformation",
        description: "Non-surgical gastric balloon with metabolic coaching",
        href: "/treatments/life-optimization/swallowable-gastric-balloon-weight-transformation",
      },
      {
        id: "iv-vitamin-therapy",
        label: "IV Vitamin Therapy",
        description: "Targeted drips for cellular hydration and recovery",
        href: "/treatments/life-optimization/iv-vitamin-therapy",
      },
      {
        ...
        href: "/treatments/life-optimization/medical-nutrition-therapy",
      },
      {
        id: "sexual-therapy",
        label: "Sexual Therapy",
        description: "Integrated medical and psychosocial sexual wellness",
        href: "/treatments/life-optimization/sexual-therapy",
      },
      {
        id: "faster-eft-advanced-tapping",
        label: "FasterEFT (Faster Emotionally Focused Transformation) - Advanced Tapping",
        description: "Advanced tapping modality for rapid emotional reset",
        href: "/treatments/life-optimization/faster-eft-advanced-tapping",
      },
      {
        id: "life-coaching",
        label: "Life Coaching",
        description: "High-performance mindset and lifestyle strategy",
        href: "/treatments/life-optimization/life-coaching",
      },
      {
        id: "biohacking",
        label: "Biohacking",
        description: "Wearables, peptides, and labs for peak optimisation",
        href: "/treatments/life-optimization/biohacking",
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/private-gp/medicated-weight-management",
      },
    ],
  },
  {
