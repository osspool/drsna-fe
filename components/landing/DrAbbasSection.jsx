...
/**
 * Dr Abbas Section Component
 *
 * Featured section highlighting Dr Abbas's credentials, philosophy, and expertise.
 * Displays doctor image, credentials grid, content paragraphs, quote card, and CTA.
 *
 ...
 * @param {string} [props.data.titleAccent] - Accent title in primary color
 * @param {Object} [props.data.image] - Doctor image and details
 * @param {Array} [props.data.credentials] - Array of credential objects with icon, title, description
 * @param {string[]} [props.data.content] - Array of content paragraphs
 * @param {Object} [props.data.quote] - Quote object with icon, text, author, subtitle
 * @param {Object} [props.data.cta] - CTA object with text and href
 */
