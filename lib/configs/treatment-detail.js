...
export const treatmentDetailPageConfig = [
  ...
  },
  {
    ...
    condition: (treatment) => treatment.emotionalConnection
  },
  {
    id: 'howItWorks',
  ...
  },
  {
    id: 'naturalHealing',
    block: 'treatment.two-column-features',
    dataKey: 'naturalHealing',
    condition: (treatment) => treatment.naturalHealing
  },
  {
    id: 'whyChooseDrSNA',
  ...
  },
  {
    id: 'detailedFeatures',
    block: 'treatment.two-column-features',
    dataKey: 'detailedFeatures',
    condition: (treatment) => treatment.detailedFeatures
  },
  {
    id: 'doctorQuote',
    block: 'block.image-quote',
    dataKey: 'doctorQuote',
    condition: (treatment) => treatment.doctorQuote
  },
  {
    id: 'gallery',
    block: 'block.gallery',
  ...
  },
  {
    id: 'healingVsMasking',
    block: 'treatment.two-column-features',
    dataKey: 'healingVsMasking',
    condition: (treatment) => treatment.healingVsMasking
  },
  {
    id: 'realResults',
    block: 'section.features',
    dataKey: 'realResults',
    condition: (treatment) => treatment.realResults,
  ...
  },
  {
    ...
    block: 'treatment.two-column-features',
    dataKey: 'treatmentExperience',
    condition: (treatment) => treatment.treatmentExperience
  },
  {
    id: 'beforeAfter',
