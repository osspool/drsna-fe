 ...
 * @param {string} baseUrl - Current domain's base URL (from getBaseUrl())
...
/**
 * Create a metadata generator function for dynamic routes - DOMAIN AWARE
 */
