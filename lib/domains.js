...
export const domains = {
  ...
  main: {
    ...
    staticPages: [
      ...
      { path: '/treatments/pain-management/treatments/stem-cell-treatment', changeFrequency: 'weekly', priority: 0.95 },
  ...
  // Erectile Dysfunction dedicated domain
  erectiledysfunction: {
    id: 'erectiledysfunction',
    name: 'Erectile Dysfunction Treatment London',
    url: 'https://erectiledysfunction-treatments.com',
    hosts: ['erectiledysfunction-treatments.com', 'www.erectiledysfunction-treatments.com', 'ed.localhost:3000'],

    // LLM-friendly metadata for AI crawlers
    llms: {
      title: 'Erectile Dysfunction Treatment London',
      description: 'Specialist clinic in London dedicated to treating erectile dysfunction using advanced, non-surgical methods like P-Shot and Shockwave Therapy. Restoring confidence and performance.',
      specialties: [
        'Erectile Dysfunction Treatment',
        'P-Shot (Priapus Shot)',
        'Shockwave Therapy',
      ...
      keyDifferentiators: [
        'Holistic approach to ED',
        'Non-surgical, natural treatments',
        'GMC-registered specialist doctor',
