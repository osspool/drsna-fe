...
export async function getAllTreatmentPaths() {
  const allTreatments = [
    ...
    { category: "life-optimization", subcategory: "services", slug: "iv-vitamin-therapy" },
    { category: "life-optimization", subcategory: "services", slug: "medicated-weight-management" },
    { category: "life-optimization", subcategory: "services", slug: "medical-nutrition-therapy" },

    // Private GP - Services
    { category: "private-gp", subcategory: "services", slug: "health-screening" },
    { category: "private-gp", subcategory: "services", slug: "illness" },
    { category: "private-gp", subcategory: "services", slug: "test-and-scan" },
    { category: "private-gp", subcategory: "services", slug: "gp-services-pricing" },
    { category: "private-gp", subcategory: "services", slug: "referrals-and-forms" },

    // Scientific Evidence
    { category: "scientific-evidence", subcategory: "treatments", slug: "fat-derived-stem-cell-joint-therapy" },
    { category: "scientific-evidence", subcategory: "treatments", slug: "bmac-therapy" },
    { category: "scientific-evidence", subcategory: "treatments", slug: "p-shot" },
    { category: "scientific-evidence", subcategory: "treatments", slug: "prp-joint-treatment" },
  ];
